			...
			<div className="w-2/5 px-16 py-12 bg-white flex flex-col justify-center">
				<div className="w-full max-w-md mx-auto">
					...
					<div className="space-y-6">
						...
						<Button className="w-full !rounded-button bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white text-xl py-8 transition-colors duration-200" size="lg">
							开始使用
						</Button>
						...
						<div className="flex justify-center space-x-6">
							<Button variant="outline" className="!rounded-button text-xl py-6 px-8" size="lg">
